...
const AllGuides = () => {
  ...
  const filteredResults = guidesData.filter((item) => {
  ...
  return (
    <div className="container">
      ...
      <div className="discovery-area">
        <Section title="Top Rated This Week" data={guidesData.filter(g => g.topRated)} />
        <Section title="Gastronomy & Food" data={guidesData.filter(g => g.specialty === "food")} />
        <Section title="Medina & Old City" data={guidesData.filter(g => g.specialty === "old cities")} />
        <Section title="Modern Architecture" data={guidesData.filter(g => g.specialty === "moden city")} />
      </div>
    </div>
  );
};
